...
public class Students {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for (IUpdater iUpdater : iUpdaters) {
            ...
            for (LossFunctions.LossFunction value : allLossFuncs()) {
                trainAndEvalModel(labelIndex, numClasses, 3000, value, iUpdater, data);
    ...
    public static void trainAndEvalModel(int in, int out, int epochs,
        ...
        final MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .layer(new DenseLayer.Builder().nIn(in)
                                               ...
                                               .build())
               // .layer(new BatchNormalization())
                .layer(new DenseLayer.Builder().nIn(15)
                                               .nOut(5)
                                              // .dropOut(0.5)
                                               .build())
               // .layer(new BatchNormalization())
        ...
        KFoldIterator kiter = new KFoldIterator(4, ds);
        int k = 0;
        double totalAccuracy = 0D;
        while (kiter.hasNext()) {
            final DataSet next = kiter.next();
    ...
    public static List<IUpdater> allUpdaters() {
        ...
        //            first /= 2;
        //        }
        iUpdaters.add(new Adam(1e-5)); // 62
